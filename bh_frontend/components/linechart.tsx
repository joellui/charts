...
const LineChart = () => {
  // @param chartData: LineChartData | null
  // @param setChartData: React.Dispatch<React.SetStateAction<LineChartData | null>>
  ...
  const [chartData, setChartData] = useState<LineChartData | null>(null); // Use defined type
  ...
  return (
    <div>
      <h2 className="font-bold text-xl">Line Chart</h2>
      <Line data={data} />
    </div>
  );
};
